...
from evaluate_rs import evaluate
...
if __name__ == '__main__':
    ...
    step = int(78000)
    encoder_path = "results/{}/saved_models/encoder.pt".format(user_args.run_name)
    detector_path = "results/{}/saved_models/detector.pt".format(user_args.run_name)
